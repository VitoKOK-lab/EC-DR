...
// v204：「二創」整頁拆掉併進「影片成效」，所以 remake 沒了、perf 出現
ok("editor: cal hub, zones integrated into work (v37)", JSON.stringify(tabs)===JSON.stringify(["chat","work","board","videos","videosDF","cal","perf"]), tabs);
