...
>
> **工作線分流（2026-07 起）**：海外剪輯（intl）的「上班計畫」只看 泰／英 二創殼（`locale:"th"/"en"`），
> 建立二創版本卡分成 English、Thai 兩區（帳號只列該語言）；國內剪輯（editor）看台灣毛片＋蝦皮／馬來西亞殼
> （馬來版由國內剪）。已認領（剪輯中）的項目不分流、永遠留在本人「我的工作」。
